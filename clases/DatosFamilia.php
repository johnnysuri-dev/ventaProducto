...
class datosfamilias{
		...
		public function agregaDatosFamilia($datos){
			$c= new conectar();
			$conexion=$c->conexion();
			$sql="INSERT into datosfamilia(tutorPadre, tutorMadre, telefono1, telefono2, ocupacionPadre, ocupacionMadre, id_estudiante)
						values ('$datos[0]',
								'$datos[1]',
								'$datos[2]',
								'$datos[3]',
