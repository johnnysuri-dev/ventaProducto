...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-06-2021 a las 16:26:25
...
INSERT INTO `unidad_educativa` (`id_unidad_educativa`, `codigo_sie`) VALUES
(1, 41980023),
(2, 0);
...
(1, 'alvaro', 'torrez', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', '2021-05-27');
...
--
ALTER TABLE `unidad_educativa`
  MODIFY `id_unidad_educativa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
